...
public class NewResourceBundleEntryPanel extends BasePanel<ApplicationDashboardBean>
{
	...
	{
		System.out.println(
			"io.github.astrapi69.bundle.app.panels.creation.NewResourceBundleEntryPanel.onCreate()");
	}
	...
	{
		System.out.println(
			"io.github.astrapi69.bundle.app.panels.creation.NewResourceBundleEntryPanel.onSave()");
	}
